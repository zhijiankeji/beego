...
func TestMail(t *testing.T) {
	config := `{"username":"zhijiankeji@gmail.com","password":"zhijiankeji","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "zhijiankeji@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "zhijiankeji" {
