...
func (o *insertSet) Insert(md interface{}) (int64, error) {
	...
	if id > 0 {
		if o.mi.fields.pks[0].auto {
			if o.mi.fields.pks[0].fieldType&IsPositiveIntegerField > 0 {
				ind.FieldByIndex(o.mi.fields.pks[0].fieldIndex).SetUint(uint64(id))
			} else {
				ind.FieldByIndex(o.mi.fields.pks[0].fieldIndex).SetInt(id)
			}
		}
	}
	return id, nil
